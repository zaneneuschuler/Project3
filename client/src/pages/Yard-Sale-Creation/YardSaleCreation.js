...
class YardSaleCreation extends Component {
    state = {
        ...
        zipCode: 12345, 
        yardSaleName: "Your Yard Sale's Name", 
    ...
    submitYardSale = () => {
        let newSale = {
            yardSaleName: this.state.yardSaleName,
    ...
    render(){
        return(
            <YardSaleCreationWrapper>
                ...
                {/* Name of Sale */}
                <YardSaleCreationElement>Name of Your Sale: <input type="text" name="yardSaleName" value={this.state.yardSaleName} onChange={this.handleInput}></input></YardSaleCreationElement>
